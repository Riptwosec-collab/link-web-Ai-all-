const CACHE='slh-v5.2.0-smooth-contrast';
const CORE=[
  './','./index.html','./css/app.css','./css/performance-v51.css','./css/card-v12.css','./css/nav-v5.css','./css/premium-v51.css','./css/smooth-v52.css',
  './js/app.js','./js/nav-v5.js','./js/instant-save-v9.js','./js/auth-gate.js','./js/db.js','./js/search.js','./js/metadata.js','./js/metadata-v9.js','./js/metadata-repair.js','./js/card-v12.js','./js/smooth-v52.js','./js/premium-v51-runtime.js','./js/shortcuts-v51.js','./js/cloud.js',
