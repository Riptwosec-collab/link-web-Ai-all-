import {getAll,getOne,putOne,deleteOne,uid,logEvent,getSetting} from './db.js';
import {getMetadata} from './metadata-v9.js';
import {refreshVisibleCard,insertVisibleCard} from './card-v12.js';
...
document.addEventListener('click',e=>{
  const choice=e.target.closest?.('[data-v53-collection]');if(choice){e.preventDefault();e.stopImmediatePropagation();chooseCollection(choice);return}
